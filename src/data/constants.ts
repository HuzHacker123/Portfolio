...
export const themeDisclaimers = {
  light: [
    ...
    "Alert: Light mode activated! Your retinas may file a complaint.",
    "Proceed with caution—this brightness wasn’t meant for mere mortals.",
    "Warning: You’re about to witness levels of brightness previously seen only in the sun.",
    "Caution: Switching to light mode may cause sudden enlightenment.",
    "Proceed with caution—this brightness wasn’t meant for mere mortals.",
  ],
  dark: [
    ...
    "Dark mode engaged. Balance in the universe has been restored.",
    "Welcome home… the light side was never meant for you anyway.",
    "You survived light mode? Impressive. Now relax in the shadows.",
    "Leaving light mode behind… character development complete",
    "Dark mode activated! Your eyes will thank you, and so will I.",
    "You chose wisely. Darkness looks good on you.",
  ],
};